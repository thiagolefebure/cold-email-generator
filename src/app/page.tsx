      ...
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow p-6 space-y-6">
        ...
        <header className="space-y-2">
          ...
          <p className="text-sm text-gray-600">
            Generate 3 personalized cold emails + 2 follow-ups in seconds.
            <br />
            First 5 generations are free.
          </p>
        ...
        <form onSubmit={onSubmit} className="grid gap-4 md:grid-cols-2">
          <input
            required
            className="border rounded-lg p-3 bg-white text-gray-900 placeholder:text-gray-500"
          ...
          <input
            required
            className="border rounded-lg p-3 md:col-span-2 bg-white text-gray-900 placeholder:text-gray-500"
          ...
          />
          <select
            className="border rounded-lg p-3 bg-white text-gray-900"
            value={form.tone}
        ...
        <div className="grid gap-2">
          ...
          <textarea
            className="w-full h-80 border rounded-lg p-3 font-mono text-sm bg-white text-gray-900 placeholder:text-gray-500"
            value={result}
